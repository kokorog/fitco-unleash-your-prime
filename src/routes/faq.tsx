...
const SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: "Мога ли да изтегля или изтрия данните си?", a: "Да — от Профил → Поверителност → Експорт / Изтриване, или с имейл до support@fitco.app." },
  ...
  return (
    <PageShell>
      <PageHero
        ...
        description="Не намираш отговор? Пиши ни на support@fitco.app — отговаряме до 24 часа."
      />
