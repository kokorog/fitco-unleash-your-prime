...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "FITCO is the premium AI-powered fitness platform for training, nutrition, and community." },
      { name: "robots", content: "noindex, nofollow" },
      { name: "author", content: "FITCO" },
      { property: "og:title", content: "FITCO — Train Smarter. Live Stronger." },
      { property: "og:description", content: "FITCO is the premium AI-powered fitness platform for training, nutrition, and community." },
      ...
      { name: "twitter:description", content: "FITCO is the premium AI-powered fitness platform for training, nutrition, and community." },
